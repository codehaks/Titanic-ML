...
using TitanicMLDemoML.Model;
using Microsoft.ML.Trainers.FastTree;

namespace TitanicMLDemoML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Codehaks\Desktop\Titanic\Train1.txt";
        private static string MODEL_FILEPATH = @"../../../../TitanicMLDemoML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Categorical.OneHotEncoding(new[] { new InputOutputColumnPair("Sex", "Sex"), new InputOutputColumnPair("Embarked", "Embarked") })
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "Sex", "Embarked", "Pclass", "Age", "SibSp", "Parch" }));

            // Set the training algorithm 
            var trainer = mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options() { NumberOfLeaves = 78, MinimumExampleCountPerLeaf = 10, NumberOfTrees = 500, LearningRate = 0.0532871f, Shrinkage = 0.09258568f, LabelColumnName = "Survived", FeatureColumnName = "Features" });
